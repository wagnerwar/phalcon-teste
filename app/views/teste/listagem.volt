        ...
        <tbody>
            <tr>
                <td colspan="7" align="right">
                    <div class="btn-group">
                        {{ link_to("teste/listagem", '<i class="icon-fast-backward"></i> First', "class": "btn") }}
                        {{ link_to("teste/listagem?page=" ~ page.before, '<i class="icon-step-backward"></i> Previous', "class": "btn") }}
                        {{ link_to("teste/listagem?page=" ~ page.next, '<i class="icon-step-forward"></i> Next', "class": "btn") }}
                        {{ link_to("teste/listagem/index?page=" ~ page.last, '<i class="icon-fast-forward"></i> Last', "class": "btn") }}
